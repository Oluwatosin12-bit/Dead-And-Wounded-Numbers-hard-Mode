...
console.log(randomNumber4);*/ console.log(randomNumber1, randomNumber2, randomNumber3, randomNumber4);
...
const startingMinutes = 4;
 ...
 setInterval(updateCountdown, 1000); //call the function every second
 ...
 function updateCountdown(){
  ...
  if (time === 0){
    lastResult.textContent = `Time is up!`;
    lastResult.style.backgroundColor = 'red';
    turnsLeftScore.innerHTML = `You have 0 turn(s) left`;
...
time = time.now;
 ...
 resetButton.style.backgroundColor = 'hsl(37, 74%, 23%)';
...
/* "seconds = seconds < 10 ? "0" + seconds : seconds */ 
//the interpretation of the above is if seconds is less than 10 then add 0 before the digit otherwise we want just the seconds
